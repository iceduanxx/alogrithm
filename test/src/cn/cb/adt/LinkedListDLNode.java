...
public class LinkedListDLNode implements LinkedList {
    ...
    public Node insertFirst(Object e) {
        DLNode node = new DLNode(head, e, head.getNext());
    ...
    public Node insertLast(Object e) {
        DLNode node = new DLNode(tail.getPre(), e, tail);
    ...
    public Node insertAfter(Node p, Object e) throws InvalidNodeException {
        DLNode node = checkPosition(p);
        DLNode newNode = new DLNode(node, e, node.getNext());
    ...
    public Node insertBefore(Node p, Object e) throws InvalidNodeException {
        DLNode node = checkPosition(p);
        DLNode newNode = new DLNode(node.getPre(), e, node);
